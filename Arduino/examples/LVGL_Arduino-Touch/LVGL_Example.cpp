...
void Lvgl_Example1(void){
  ...
  lv_obj_t * t1_2 = lv_tabview_add_tab(tv2, "Onboard");
  Onboard_create(t1_2);
}
...
static void Onboard_create(lv_obj_t * parent)
{
  ...
  // lv_obj_set_grid_cell(Wireless_label, LV_GRID_ALIGN_START, 0, 5, LV_GRID_ALIGN_START, 10, 1);
  // lv_obj_set_grid_cell(Wireless_Scan, LV_GRID_ALIGN_STRETCH, 0, 5, LV_GRID_ALIGN_CENTER, 11, 1);
  lv_obj_set_grid_cell(Backlight_label, LV_GRID_ALIGN_START, 0, 5, LV_GRID_ALIGN_START, 6, 1);
  lv_obj_set_grid_cell(Backlight_slider, LV_GRID_ALIGN_STRETCH, 0, 5, LV_GRID_ALIGN_CENTER, 7, 1);
