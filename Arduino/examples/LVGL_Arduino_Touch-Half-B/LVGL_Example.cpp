...
static void Onboard_create(lv_obj_t * parent)
{
  ...
  lv_obj_set_grid_cell(Backlight_label, LV_GRID_ALIGN_START, 0, 1, LV_GRID_ALIGN_START, 8, 1);
  lv_obj_set_grid_cell(Backlight_slider, LV_GRID_ALIGN_STRETCH, 0, 1, LV_GRID_ALIGN_CENTER, 9, 1);
